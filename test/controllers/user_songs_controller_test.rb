...
class UserSongsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_song" do
    assert_difference('UserSong.count') do
      post user_songs_url, params: { user_song: { position: @user_song.position, song_id: @user_song.song_id, user_id: @user_song.user_id } }
    end
  ...
  test "should update user_song" do
    patch user_song_url(@user_song), params: { user_song: { position: @user_song.position, song_id: @user_song.song_id, user_id: @user_song.user_id } }
